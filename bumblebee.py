...
class BumblebeeBase(nn.Module):
    def __init__(self, input_dim, label_dim, group_size, group, sync_stats, deconv_setting,
        ...
        super(BumblebeeBase, self).__init__()
        # setting of sync BN
        global BN
...
def BumblebeeV1(load_pretrain=True, T=10, input_dim=256, label_dim=256, group_size=1, group=None, sync_stats=False,
    ...
    model = BumblebeeBase(input_dim, label_dim, group_size, group, sync_stats, deconv_setting,
                          interverted_residual_setting)
    return model


## 1/4
def BumblebeeV5(load_pretrain=True, T=10, input_dim=256, label_dim=256, group_size=1, group=None, sync_stats=False,
                input_size=224, width_mult=1.):
    deconv_setting = []
    # setting of deconv blocks
    deconv_setting = [
